...
namespace ConsoleBierenClient.EtikettenServiceReference {
    ...
    public interface IEtikettenService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://vdab.be/etikettenservice/IEtikettenService/StopVerwittigAlsEtikettenVerwij" +
            "derdZijn")]
        void StopVerwittigAlsEtikettenVerwijderdZijn();
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://vdab.be/etikettenservice/IEtikettenService/StopVerwittigAlsEtikettenVerwij" +
            "derdZijn")]
        System.Threading.Tasks.Task StopVerwittigAlsEtikettenVerwijderdZijnAsync();
    }
    ...
    public partial class EtikettenServiceClient : System.ServiceModel.DuplexClientBase<ConsoleBierenClient.EtikettenServiceReference.IEtikettenService>, ConsoleBierenClient.EtikettenServiceReference.IEtikettenService {
        ...
        public void StopVerwittigAlsEtikettenVerwijderdZijn() {
            base.Channel.StopVerwittigAlsEtikettenVerwijderdZijn();
        }
        
        public System.Threading.Tasks.Task StopVerwittigAlsEtikettenVerwijderdZijnAsync() {
            return base.Channel.StopVerwittigAlsEtikettenVerwijderdZijnAsync();
        }
    }
}
